...
@dso_cache = dso_local local_unnamed_addr global [52 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 5118476022769565112, ; hash 0x47087ad2e888bdb8, from name: libassimp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libassimp.so
		ptr null; void* handle (0x0)
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7438827678382124856, ; hash 0x673c065c634f6f38, from name: assimp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libassimp.so
		ptr null; void* handle (0x0)
	}, ; 18
	...
	%struct.DSOCacheEntry {
		i64 9062004942777055905, ; hash 0x7dc2b57b9f0f7aa1, from name: libcimgui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libcimgui.so
		ptr null; void* handle (0x0)
	}, ; 27
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 10510705843190410634, ; hash 0x91dd8746b9fcad8a, from name: libassimp.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libassimp.so
		ptr null; void* handle (0x0)
	}, ; 30
	...
	%struct.DSOCacheEntry {
		i64 12023925733842613278, ; hash 0xa6dd90bfdb5df41e, from name: cimgui.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libcimgui.so
		ptr null; void* handle (0x0)
	}, ; 33
	...
	%struct.DSOCacheEntry {
		i64 14681467323983979005, ; hash 0xcbbf0cbed391e1fd, from name: cimgui
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libcimgui.so
		ptr null; void* handle (0x0)
	}, ; 38
	...
	%struct.DSOCacheEntry {
		i64 15431740770419353410, ; hash 0xd6288e7846c22742, from name: libcimgui.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libcimgui.so
		ptr null; void* handle (0x0)
	}, ; 41
	%struct.DSOCacheEntry {
		i64 15524342577955063149, ; hash 0xd7718b52ba7bc56d, from name: assimp.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libassimp.so
		ptr null; void* handle (0x0)
	}, ; 42
...
@.env.7 = private unnamed_addr constant [37 x i8] c"770548eb-2a9e-42b0-8848-cdffdfae028f\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.example.minimikudancemaui\00", align 16
...
@.DSOCacheEntry.11_name = private unnamed_addr constant [13 x i8] c"libassimp.so\00", align 1
@.DSOCacheEntry.12_name = private unnamed_addr constant [13 x i8] c"libcimgui.so\00", align 1
